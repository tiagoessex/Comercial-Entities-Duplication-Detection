...
def test1_2():
	...
	d2 = {'name':"bar da treta", 'address':'av. da boavista n 50, porto, portugal'}
	if not isDup_0(d1,d2,min_ratio=80):
		return True
	else:
		return False
...
def test1_4():
	...
	if not isDup_0(d1,d2,min_ratio=85):
		return True
	else:
		return False
...
def test1_6():
	...
	d1 = {'name':"a loja 1 a treta", 'address':'da boavista n 50, porto, portugal', "nif":123456}
	d2 = {'name':"a loja 1 a treta", 'address':'da boavista n 50, porto, portugal', "nif":123456}

	if isDup_0(d1,d2,min_ratio=98):
		return True
	else:
		return False
...
def test2_4():
	...
	if isDup_1(d1,d2,max_radius=1000000) == True:	# 1000 km
		return True
	else:
		return False
...
def test3_2():
	...
	if not isDup_2(d1,d2,min_ratio=80):
		return True
	else:
		return False
...
def test3_4():
	...
	if not isDup_2(d1,d2,min_ratio=85):
		return True
	else:
		return False
